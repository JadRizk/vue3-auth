...
*/
export async function loginService(username: string, password: string): Promise<AxiosResponse<LoginAPIResponse>> {
...
*/
export function registerService(user: RegisterUserInfo): Promise<AxiosResponse<RegisterAPISuccess>> {
    const config: AxiosRequestConfig = {
        method: 'POST',
        url: '/player/register',
        data: {
